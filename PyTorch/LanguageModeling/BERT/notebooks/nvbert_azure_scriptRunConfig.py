...
script_params = [
    ...
    '--output_dir', get_output_dataset(cog_ds, '/output/' + outputSuffix + '/output_dir', "output_dir"),
    '--json-summary', get_output_dataset(cog_ds, '/output/' + outputSuffix + '/dllogger', "dllogger"),
    '--fp16',
